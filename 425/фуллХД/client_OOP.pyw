...
messageInput.focus()
messageInput.bind('<Return>', SM.sendMessage)
send_image = PhotoImage(file='Send.png')
Button(canvasBG, image=send_image, activebackground="black", bd=0, bg='black', command=SM.sendMessage2).place(x=570,y=460)
...
connectionButton = Button(canvasBG, text='Подключится \nк серверу', bg='black', activebackground="#FF8D24", bd=4, fg='white', command=InterWin.openConnection)
